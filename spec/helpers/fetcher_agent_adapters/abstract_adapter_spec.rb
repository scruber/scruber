...
RSpec.describe Crawley::Helpers::FetcherAgentAdapters::AbstractAdapter do
  ...
  describe "initialize" do
    ...
    it "set values" do
      ...
      expect(agent.user_agent).to eq('Crawley')
    ...
    it "parse cookies from page" do
      page = Crawley::QueueAdapters::AbstractAdapter::Page.new(nil, 'http://example.com', response_headers: {"Connection" => "keep-alive","Set-Cookie" => "__cfduid=dc8db498b1e419b7943052a69c8e9d1d01504311966; expires=Sun, 02-Sep-18 00:26:06 GMT; path=/; domain=example.com; HttpOnly"})
