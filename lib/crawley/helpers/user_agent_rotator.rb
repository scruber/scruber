    ...
    class UserAgentRotator
      ...
      class UserAgent
        ...
        def initialize(name, options={})
          @name = name
          raise Crawley::ArgumentError.new("You need to specify name") if @name.nil? || @name.empty?
      ...
      class << self
        ...
        def next(tags=nil)
          raise Crawley::ArgumentError.new("UserAgent rotator not configured") if @configuration.nil?
